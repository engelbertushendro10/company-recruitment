...
const routes1 = require('../controllers/engineer')
const routes2 = require('../controllers/company')
                    ...
                    modelEngineer.getEngineerById(id_user)
                        .then(eng => {
                            ...
                            if (bcryptjs.compareSync(password, passwordHash)) {
                                const token = jwt.sign({ id_user: id_user }, process.env.JWT_KEY, { expiresIn: '100d' })
