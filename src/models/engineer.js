...
module.exports = {
    ...
    getEngineer: (data) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            GROUP_CONCAT(DISTINCT skill.skill_name) 
            as skills, engineer.location, 
            engineer.birth, 
            GROUP_CONCAT(DISTINCT showcase.showcase) as showcase, 
            engineer.e_salary, engineer.image,
            engineer.date_created, 
            engineer.date_updated
            FROM skills
    ...
    getEngineerById: (id_user) => {
        return new Promise((resolve, reject) => {
            console.log(id_user, "ini id enginer di model")
            db.query(`SELECT * FROM engineer where id_user=${id_user}`, (err, response) => {
                if (!err) {
                    resolve(response);
                } else {
                    reject(err);
    ...
    addEngineer: (data) => {
        return new Promise((resolve, reject) => {
            db.query('INSERT INTO engineer SET ?', data, (err, response) => {
                if (!err) {
                    resolve(response)
                } else {
